...
\conferenceinfo{MMSys '16}{May 10--13, 2016, Klagenfurt am W\"{o}rthersee,
  Austria}
%\doi{}
%\isbn{}
%\acmPrice{}
...
inter-coded (\cite{khattak:fast}, \cite{vetro:overview}, e.g.). An example is
...
\end{center}
\caption{
The view-internal structure we use in our tests. Pictures in the dependent
view use inter-view coding only.
}
...
\begin{figure}
\centering
\includegraphics[scale=.68]{figures/motion_vector_data_unconstrained_unidirectional.eps}
\caption{
...
\begin{figure}
\centering
\includegraphics[scale=.68]{figures/motion_vector_data_unconstrained_bidirectional.eps}
\caption{
